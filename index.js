    ...
    if (predictions.length > 0) {
      predictions.forEach(prediction => {
        if(n == 0) {
            ...
            console.log(`prediction.mesh length: ${prediction.mesh.length}`);
            console.log(`prediction.mesh length: ${prediction.scaledMesh.length}`);
        ...
        /* const keypoints = prediction.annotations.lipsUpperOuter
                            .concat(
                                ...
                                prediction.annotations.lipsUpperInner,
